                  ...
                  <div className="relative">
                    ...
                    {exerciseFilterOpen && (
                      <div className="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg z-10 border border-gray-200 p-3">
                        ...
                        <div className="max-h-60 overflow-y-auto">
                          {activeProcessedData.currentProgramData?.exercises?.map((exercise) => (
              ...
              <div className="mb-4">
                ...
                >
                  <WeightRepCorrelationChart
                    weightData={activeProcessedData.currentProgramData?.weightData[selectedExercise] || []}
                    repData={activeProcessedData.currentProgramData?.repData[selectedExercise] || []}
                    weekLabels={activeProcessedData.currentProgramData?.weekLabels}
          ...
          {activeTab === "onerepmax" && (
            <div className="mt-0">
              <div className="mb-4">
                ...
                >
                  <OneRepMaxChart
                    exerciseData={activeProcessedData.currentProgramData?.exerciseData}
